export const goToHomeFixtures = [
  ...
  { input: '420*1*1*0', output: '' },
  { input: '420*1*1*0*1*2', output: '1*2' },
  { input: '420*1*1*0*1*2*0', output: '' },
  { input: '420*1*1*0*1*2*0*3*1', output: '3*1' },
  { input: '0', output: '' },
  { input: '0*1', output: '1' },
];
...
export const ussdRouterFixtures = [
  ...goToHomeFixtures,
  ...goBackFixtures,
  { input: '420*1*1*0*2*3*00', output: '2' },
  { input: '420*1*1*00*2*0*2', output: '2' },
  { input: '420*1*0*2*3*00*4*5*00', output: '2*4' },
  { input: '420*1*0*2*3*00*4*5*00*John Doe*1', output: '2*4*John Doe*1' },
];
